...
$pdf->Ln(6);
$pdf->cell(140, 4, utf8_decode('FIRMA: ____'.$codigo.'____ CC: '.$prospecto_cedula), 0, 0, 'L');$pdf->cell(140, 4, utf8_decode('FIRMA: ___________________ CC: ______________'), 0, 0, 'L');
$pdf->Output();