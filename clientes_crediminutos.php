...
<!-- update orders section -->
                                        ...
                                        <label>Seleccione Cedula Cliente:</label>
                                            ...
                                            <div class="input-group">
                                               ...
                                               <select  class="form-control select2Class" name="cedula_prospecto" id="cedula_prospecto" style="width: 100%; height:36px;" autocomplete="ÑÖcompletes">
                                                        ...
                                                        $query = "SELECT prospectos.id AS id_prospecto, prospecto_cedula, prospecto_nombre, prospecto_apellidos FROM prospectos LEFT JOIN prospecto_detalles ON prospecto_detalles.id_prospecto = prospectos.id WHERE prospectos.del = 0 AND prospectos.id_plataforma = 2 ORDER BY prospecto_detalles.prospecto_nombre";
        ...
        <div class="row" id="table-space-report1">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Clientes Crediminuto</h4>
                        <div class="table-responsive m-t-40 table_clientes_crediminuto">
                            <table id="dataTableClienteCrediminuto" class="table-patient table display table-bordered table-striped no-wrap">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>CEDULA #</th>
