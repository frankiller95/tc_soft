...
$pdf->Ln(10);
$pdf->MultiCell(190, 4, utf8_decode('1. La suma de __________________________________________________________________________________ ($                                        )'), 0, 'FJ');
...
$pdf->Ln(15);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50, 5, utf8_decode('_______________________'), 0, 0, 'L');
$pdf->Ln(10);
